                ...
                <div class="panel-heading">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
                        <div class="row" align="right">
                             <button type="button" name="add" id="add_button" data-toggle="modal" data-target="#categoryModal" class="btn btn-success btn-xs">Cadastrar Nova Categoria</button>
                        </div>
                    </div>
    		...
    		<form method="post" id="category_form">
    			<div class="modal-content">
    				<div class="modal-header">
						...
						<h4 class="modal-title"><i class="fa fa-plus"></i> Cadastrar Categoria</h4>
    				</div>
...
$(document).ready(function(){
	...
	$('#add_button').click(function(){
		...
		$('.modal-title').html("<i class='fa fa-plus'></i> Cadastrar Categoria");
		$('#action').val('Salvar');
		$('#btn_action').val('Add');
	});
