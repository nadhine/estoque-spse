    		...
    		<form method="post" id="order_form">
    			<div class="modal-content">
    				<div class="modal-header">
						...
						<h4 class="modal-title"><i class="fa fa-plus"></i> Cadastrar Movimentação</h4>
    				</div>
    				<div class="modal-body">
						...
						<div class="form-group">
							...
							<select name="payment_status" id="payment_status" class="form-control">
								<option value="cash">Entrada</option>
								<option value="credit">Saída</option>
							</select>
						</div>
    				</div>
...
<script type="text/javascript">
    $(document).ready(function(){
		...
		$('#add_button').click(function(){
			...
			$('#order_form')[0].reset();
			$('.modal-title').html("<i class='fa fa-plus'></i> Cadastrar Movimentação");
			$('#action').val('Salvar');
			$('#btn_action').val('Add');
