                    ...
                    <div class="panel-heading">
                    	<div class="row">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6" align='right'>
                                <button type="button" name="add" id="add_button" class="btn btn-success btn-xs">Cadastrar Novo Produto</button>
                            </div>
                        </div>
                    </div>
                ...
                <form method="post" id="product_form">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title"><i class="fa fa-plus"></i> Cadastrar Produto</h4>
                        </div>
            ...
            <div class="modal-dialog">
                <form method="post" id="product_form">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title"><i class="fa fa-plus"></i> Detalhes</h4>
                        </div>
                        <div class="modal-body">
...
$(document).ready(function(){
    ...
    $('#add_button').click(function(){
        ...
        $('.modal-title').html("<i class='fa fa-plus'></i> Cadastrar Produto");
        $('#action').val("Salvar");
        $('#btn_action').val("Add");
    });
    ...
    $(document).on('click', '.update', function(){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $('.modal-title').html("<i class='fa fa-pencil-square-o'></i> Editar Produto");
